...
for week_number in range(1, 6):
    ...
    if week_number == 1:
        inlier_uid = [96243, 126901, 171082, 283682, 200160, 79486, 83536, 96243, 10364885, 126493, 5437, 9016245, 8959747, 7911021, 10320236, 10286875, 10019464, 9481638, 9016245]
