...
def draw_diff(vid):
    result = []
    cap = cv2.VideoCapture('/Users/maomaoyu/Downloads/Java_video/' + vid + '.mp4')
    ...
    plt.savefig('/Users/maomaoyu/Downloads/Java_video/diff_images/frame_diff_' + vid + '.eps', bbox_inches='tight', pad_inches=0)
    # plt.savefig('4a2f0738f6074e8a887911b6df66bf1c.eps', bbox_inches='tight', pad_inches=0)
    plt.close()


for file in os.listdir('/Users/maomaoyu/Downloads/Java_video/'):
    if file.split('.')[-1] == 'mp4':
