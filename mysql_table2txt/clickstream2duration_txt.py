...
cursor = conn.cursor()
sql1 = """select user_id, video_id, sum(TIMESTAMPDIFF(SECOND,real_time_start, real_time_end)) from HKUSTx_COMP102_1x_4T2015_video_play_piece group by user_id, video_id"""
